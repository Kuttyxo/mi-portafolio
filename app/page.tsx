...
import Projects from "@/components/Projects"; // <--- Importar aquí
...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0f0a15] bg-grid-white relative selection:bg-kutty-primary/30 selection:text-white">
      ...
      <div className="relative z-10 pt-36 pb-20 px-4 md:px-8 space-y-32"> {/* space-y-32 separa las secciones verticalmente */}
        <BentoGrid />
